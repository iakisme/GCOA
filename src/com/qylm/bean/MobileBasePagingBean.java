 ...
 * @author 
 */
public abstract class MobileBasePagingBean implements Serializable{
	 ...
	 * @param onePageCount
	 */
	public MobileBasePagingBean(int onePageCount) {
