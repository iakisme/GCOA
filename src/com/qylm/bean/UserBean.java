...
public class UserBean implements Serializable {
	...
	public void loginOut() {
		...
		user = null;
		try {
			FacesContext.getCurrentInstance().getExternalContext().redirect("/GCOA" + Navigation.EXCEPTION_HANDLER);
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
	 ...
	 * @return
	 */
	public String login(User u, boolean mobile) {
		user = u;
		this.mobile = mobile;
		Tool.sendLog(LOG, this, "手机用户成功登陆");
		return Navigation.MOBILE_MAIN;
	}
