 ...
 * @author smj
 */
@FacesConverter("engineeringProjectConverter")
public class EngineeringProjectConverter implements Converter {

	public Object getAsObject(FacesContext fc, UIComponent uic, String value) {
		if (value != null && value.trim().length() > 0) {
			try {
				EngineeringProjectService service = ApplicationContextHelper.getBean("engineeringProjectService");
